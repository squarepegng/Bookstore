# Deployment Guide: Bookstore Website (Netlify Frontend + Render Backend)

This guide walks you through deploying your full-stack bookstore app to the cloud in about 15 minutes.

**What you'll get:**
- Frontend (React/Vite) hosted on Netlify — fast, free static hosting.
- Backend (Node/Express) hosted on Render — free tier available.
- Database (MongoDB) on MongoDB Atlas — free shared cluster.
- Live bookstore website accessible from anywhere.
